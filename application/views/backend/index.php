  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?= base_url('Dashboard'); ?>" class="brand-link">
        <span class="brand-text font-weight-light">BRANGKAS SECURITY</span>
      </a>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= base_url('Dashboard/riwayat'); ?>" class="nav-link">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= base_url('Dashboard/akses'); ?>" class="nav-link">
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2020 Brangkas Security </strong>
    </footer>
